...
import ErrorList from "@components/Pokemon/ErrorList";
  ...
  <AdminLayout>
    <Card>
      <Card.Header>
        ...
        >
          <h3>Errors</h3>
          <h5> Total: {props.Errors.total}</h5>
        </div>
      </Card.Header>
      <Card.Body>
        <ErrorList Errors={props.Errors.data} />
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  const { data: Errors, headers } = await axios.get<Error>(errorListUrl, {
    headers: {
      "X-API-KEY":
        "6arXZMrHEWGWslD1R8z5VsghgvPakv998qgTsbtCS5Jupi950bFhcMf8qU1w011kKU0zRgCBOUwZ8DZYSIEZAQTNrGHWWwPRm6oK5o6Q3oDPOxuyzPku1bJQsmaJjY9h",
    },
    params: {
      page: page,
    },
